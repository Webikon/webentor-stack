...
// Host root, this would be used in WP_HOME env and should fix the multisite issue where all urls are get from the main site
// See: https://github.com/roots/bedrock/issues/325
// See: https://github.com/roots/bedrock/pull/216/files
$webroot_host = (env('WP_NO_SSL') == 'true' ? 'http://' : 'https://') . (!empty($_SERVER['HTTP_HOST']) ? $_SERVER['HTTP_HOST'] : 'localhost');

/**
 * Set up our global environment constant and load its config first
 * Default: development
 *
 * WP_ENV and WP_ENVIRONMENT_TYPE defined in Gitlab for staging/prod
 */
 ...
 * URLs
 */
Config::define('WP_HOME', $webroot_host);
Config::define('WP_SITEURL', "$webroot_host/wp");
...
/**
 * WP Rocket settings.
 * So we can use plugin from Composer
 */
